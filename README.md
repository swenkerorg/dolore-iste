...
[![NPM Package](https://img.shields.io/npm/v/@swenkerorg/dolore-iste.svg?style=flat)](https://npmjs.org/package/@swenkerorg/dolore-iste "View this project on npm")
...
```javascript
var Fraction = require('@swenkerorg/dolore-iste');
// or
import Fraction from '@swenkerorg/dolore-iste';
```
...
===
The simplest job for @swenkerorg/dolore-iste is to get a fraction out of a decimal:
```javascript
...
I published another example on how to approximate PI with @swenkerorg/dolore-iste on my [blog](http://www.xarg.org/2014/03/precise-calculations-in-javascript/) (Still not the best idea to approximate irrational numbers, but it illustrates the capabilities of Fraction.js perfectly).
...
Exceptions
===
If a really hard error occurs (parsing error, division by zero), *@swenkerorg/dolore-iste* throws exceptions! Please make sure you handle them correctly.



Installation
===
Installing @swenkerorg/dolore-iste is as easy as cloning this repo or use the following command:

```
npm install @swenkerorg/dolore-iste
```

Using Fraction.js with the browser
===
```html
<script src="@swenkerorg/dolore-iste"></script>
<script>
